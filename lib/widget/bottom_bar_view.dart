  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget child) {
            return Transform(
              ...
              child: PhysicalShape(
                color: Colors.white,
                elevation: SizeConfig.blockSizeHorizontal * 4.0,
                clipper: TabClipper(
        ...
        //   child: SizedBox(
        //     width: SizeConfig.blockSizeHorizontal * 9.5 * 2.0,
        //     height: SizeConfig.blockSizeHorizontal * 9.5 +
        //         SizeConfig.blockSizeHorizontal * 14.0,
        //     child: Container(
        //       alignment: Alignment.topCenter,
        //       color: Colors.transparent,
        //       child: SizedBox(
        //         width: SizeConfig.blockSizeHorizontal * 9.5 * 2.0,
        //         height: SizeConfig.blockSizeHorizontal * 9.5 * 2.0,
        //         child: Padding(
                ...
                ScaleTransition(
                    ...
                    child: Column(children: [
                      ...
                      Text(widget.tabIconData.name,
                          style: TextStyle(
                              fontWeight: widget.tabIconData.isSelected
                                  ? FontWeight.w600
                                  : FontWeight.normal,
